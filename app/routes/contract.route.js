...
const { validateCreateContract, validateGetContractList, validateVerifyContract, validateGetContract, validateContractApproved, uploadFile } = require('../middlewares/contract.middleware')
