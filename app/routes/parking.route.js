...
const { createParking, getActiveParkingList, endParking, paymentVerified, parkingChargesCollection } = require('../controllers/parking.controller')
...
module.exports = function (app, apiVersion) {
  ...
  app.get(route + '/parking/:id', passport.authenticate('jwt', { session: false }), parkingChargesCollection)
}
